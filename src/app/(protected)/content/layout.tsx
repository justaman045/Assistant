...
export default function ContentLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col gap-0">
      ...
      <div
        className="sticky top-0 z-20 -mx-4 mb-6 border-b border-gray-200/80 dark:border-gray-800/80 md:-mx-8"
        style={{ backgroundColor: "var(--background)" }}
      >
        <div className="flex items-center gap-0.5 overflow-x-auto px-4 md:px-8">
